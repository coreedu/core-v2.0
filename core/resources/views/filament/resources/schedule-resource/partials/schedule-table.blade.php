...
<div class="rounded-lg overflow-hidden shadow border border-gray-700">
    <table class="min-w-full text-sm text-center border-collapse">
        <!-- <table class="min-w-full text-sm text-center border-collapse rounded-lg overflow-hidden"> -->
